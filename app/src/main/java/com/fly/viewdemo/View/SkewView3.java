...
/**
 * https://insight.io/github.com/sunnyxibei/HenCoderPractice/tree/master
 * Created by Fj on 2018/4/10.
 */

public class SkewView3 extends View {
    ...
    public SkewView3(Context context) {
        this(context,null);
    }

    public SkewView3(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SkewView3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
